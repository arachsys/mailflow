...
if tuple(map(int, os.popen(command).read().strip().split('.'))) < (8, 0):
    sys.stderr.write("MailFlow requires Apple Mail 8.0 or later\n")
    sys.exit(1)
...
os.system('defaults write com.apple.mail BundleCompatibilityVersion 8')
